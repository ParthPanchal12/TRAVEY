...
/**
 * Created by nemesis on 22/3/16.
 */
public class GeoAutoCompleteAdaptor extends BaseAdapter implements Filterable {
    private static final int MAX_RESULTS = 10;
    private Context mContext;
    private List resultList = new ArrayList();

    public GeoAutoCompleteAdaptor(Context context) {
        mContext = context;
    }

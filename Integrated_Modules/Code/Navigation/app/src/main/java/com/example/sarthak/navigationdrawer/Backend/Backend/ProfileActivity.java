    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                edit.commit();
                    Intent loginactivity = new Intent(ProfileActivity.this,Login.class);

                startActivity(loginactivity);
                finish();*/

                //startActivity(new Intent(ProfileActivity.this, picUploader.class));
            ...
            public void onClick(View view) {
                ...
                chgpassfr.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("http://192.168.0.107:8080/api/chgpass",params);
                        if(json != null){
                            try{
